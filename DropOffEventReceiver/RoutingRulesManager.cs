...
namespace DropOffEventReceiver
{
    ...
    public class RoutingRulesManager : IDisposable, ITraceable
    {
        #region fields
        ...
        {
            foreach (SPListItem routingRule in this.RoutingRules)
                UnifiedLoggingServer.LogMedium(header + "Ruls_:" + routingRule.Title);
        }
        #endregion
