// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnifiedLoggingService.cs" company="Montrium">
//   MIT License
// </copyright>
// <summary>
...
namespace DropOffEventReceiver
{
    ...
    public class UnifiedLoggingServer : SPDiagnosticsServiceBase
    {
        ...
        private static string ServiceName = "Montrium-MTM_Logging_Service";

        /// <summary>The area name.</summary>
        private static string AreaName = "Montrium-MTM_Solutions";

        /// <summary>The category.</summary>
        private static string Category = "Montrium-MTM_RUBi_Methods";
