// --------------------------------------------------------------------------------------------------------------------
// <copyright file="XmlLookupManager.cs" company="Montrium">
//   MIT License
// </copyright>
// <summary>
//   The xml lookup reader.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace DropOffEventReceiver
{
    ...
    /// <summary>XmlLookup Manager.</summary>
    public class XmlLookupManager : IDisposable, ITraceable
    {
        #region fields
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the <see cref="XmlLookupManager"/> class.</summary>
        /// <param name="xmlProperties">The xml properties.</param>
        public XmlLookupManager(string xmlProperties)
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="XmlLookupManager"/> class.
        /// Releases unmanaged resources and performs other cleanup operations before the
        /// <see cref="XmlLookupManager"/> is reclaimed by garbage collection.
        ...
        {
            string fieldName = spField.Title.Replace(" ID", " Id").Replace("(Converted Document)", String.Empty).Replace(" ", String.Empty);
        ...
        {
            string fieldName =
                spField.Title.Replace(" ID", " Id").Replace("(Converted Document)", String.Empty).Replace(" ", String.Empty);
            List<XmlLookupNode> xmlLookupNodes = this.LookupNodeList;
        ...
        {
            UnifiedLoggingServer.LogMedium(header + "XLM_ListCount_:" + this.LookupNodeList.Count);
        }
        #endregion
        ...
        /// Finds the lookups.
        /// </summary>
        /// <param name="xmlDocumentElement">The xml Document Element.</param>
        /// <returns>
            ...
            foreach (XmlNode xmlNodeProperty in xmlDocumentElement.ChildNodes)
                if (xmlNodeProperty.ChildNodes.Count == 3 &&
                    ...
                    xmlLookupNodesList.Add(
                        new XmlLookupNode(
                            xmlNodeProperty.FirstChild.InnerText,
