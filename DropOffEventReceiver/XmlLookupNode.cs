...
namespace DropOffEventReceiver
{
    ...
    public class XmlLookupNode : IDisposable, ITraceable
    {
        #region fields
        ...
        public XmlLookupNode(string fieldName, string fieldValue, string fieldType)
        {
            ...
            this.CamelCaseName = fieldName.Split(';')[0].Replace("_x0020_", String.Empty).Replace("xd_", String.Empty).Replace("_", String.Empty);
            this.Type = fieldType;
        ...
        {
            UnifiedLoggingServer.LogMedium(header + "XLN_Camel_:" + this.CamelCaseName);
            UnifiedLoggingServer.LogMedium(header + "XLN_NCamel:" + this.GetSentenceName());
            UnifiedLoggingServer.LogMedium(header + "XLN_Type__:" + this.Type);
            UnifiedLoggingServer.LogMedium(header + "XLN_Value_:" + this.Value);
        }
        #endregion
